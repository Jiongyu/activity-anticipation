...
int main(int argc, char **argv)
{
    ...
    ros::Publisher pub = nh.advertise<sensor_msgs::JointState>("/climbot5d/joint_command", 1);
    ros::Subscriber sub_transform = nh.subscribe("/climbot5d/transform", 100, transform_callback);
    ros::Subscriber sub_pose = nh.subscribe("/climbot5d/joint_state", 100, pose_callback);
