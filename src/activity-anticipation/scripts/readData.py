...
#import os
#print (os.getcwd())
sys.path.append("./src/activity-anticipation/src/NeuralModels")
import numpy as np
import re
...
def sortActivities(folder):
    ...
    ground_truth='./src/activity-anticipation/src/activity-anticipation/features_ground_truth/features_binary_svm_format'

    #dataset = '/scail/scratch/group/cvgl/ashesh/activity-anticipation/dataset/fold_{0}'.format(fold)
    dataset = './src/activity-anticipation/src/activity-anticipation/dataset/fold_{0}'.format(fold)
...
if __name__ == '__main__':
	...
	folds = ['1','2','3','4']	
	#folds = ['arranging_objects','cleaning_objects','having_meal','making_cereal','microwaving_food','picking_objects','stacking_objects','taking_food','taking_medicine','unstacking_objects']
	...
	for fold in folds:	
		...
		s='./src/activity-anticipation/src/activity-anticipation/features_ground_truth/features_binary_svm_format'
		#test_file = '/scail/scratch/group/cvgl/ashesh/activity-anticipation/activityids_fold{0}.txt'.format(fold)
		test_file = './src/activity-anticipation/src/activity-anticipation/activity/fold{0}'.format(fold)
		...
		for j in folds:
			...
			train_file = './src/activity-anticipation/src/activity-anticipation/activity/fold{0}'.format(fold)
