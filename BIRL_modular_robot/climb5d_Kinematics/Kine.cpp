...
void Trans_PosToMtx(double* pos, MtxKine* output, int inv)//该算法以 Z-Y-X欧拉角坐标系 表示
{
	double ld_temp[6];
...
void Robot_IncreTransTool(IN double* currpos, IN double* increpos, OUT double* outpos)//gu
{
	MtxKine lm_input;
	MtxKine lm_middle;
	MtxKine lm_output;
