...
def main():
    ...
    ground_truth_label_activity = '{0}/person2/Subject3_annotations/microwaving_food/labeling.txt'.format(dataset_CAD120_path)
    object1_location =  '{0}/person2/Subject3_annotations/microwaving_food/{1}_obj1.txt'.format(dataset_CAD120_path,activity)
    object2_location =  '{0}/person2/Subject3_annotations/microwaving_food/{1}_obj2.txt'.format(dataset_CAD120_path,activity)
