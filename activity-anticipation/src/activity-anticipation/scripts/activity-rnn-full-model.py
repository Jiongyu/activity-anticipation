...
if __name__ == '__main__':
	...
	for fold in folds:
		main_path = ''
		if soc.gethostname()[:6] == "tan-pc":
			#main_path = '/scr/ashesh/activity-anticipation'
			#main_path = '/scail/scratch/group/cvgl/ashesh/activity-anticipation'
			main_path = './src/activity-anticipation/src/activity-anticipation/'

		elif soc.gethostname() == "ashesh":
			main_path = '.'

		path_to_dataset = '{1}/dataset/fold_{0}'.format(fold,main_path)
		path_to_checkpoints = '{1}/checkpoints_anticipation/fold_{0}'.format(fold,main_path)
